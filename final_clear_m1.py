...
if __name__ == "__main__":
    ...
    # Wait for messages from subscribers
    ...
    publisher_speaker.publish("Starting the demo!, no bug")
    ...
    while not rospy.is_shutdown():
                    ...
                    if cx !=0:
                        ...
                        if haiya==1:
                            ...
                            for i in range(300):
                                ...
                                _cmd_vel.publish(msg)
                            time.sleep(3)
                            joint1, joint2, joint3, joint4 = 0.000, 1.20, 0.2,-0.5
                            set_joints(joint1, joint2, joint3, joint4, t)
                            time.sleep(t)
                            
                            joint1, joint2, joint3, joint4 = 0.000, 0.0, 0.2,-0.5
                            set_joints(joint1, joint2, joint3, joint4, t)
                            time.sleep(t)
                            close_gripper(t)
                            time.sleep(2)
        ...
        if step == "follow":
            ...
            msg.angular.z = z
            _cmd_vel.publish(msg)
            if "thank" in s or "stop" in s or "Thank" in s:
                print(s)
